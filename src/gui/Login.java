...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField3.setToolTipText("@UserName : MyName");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/7124276_university_harvard_logo_icon (1).png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/MainLogin - Copy.jpg"))); // NOI18N

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel8.setBackground(new java.awt.Color(0, 0, 0));
        jLabel8.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel8.setText("2023 Inc");

        jLabel7.setBackground(new java.awt.Color(0, 0, 0));
        jLabel7.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel7.setText("Harvard University Admin Login");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (!jTextField3.getText().isEmpty() || !String.valueOf(jPasswordField1.getPassword()).isEmpty()) {
            try {
                ResultSet resultSet = MySQL.Search("SELECT * FROM `admin` WHERE `username`='" + jTextField3.getText() + "' "
